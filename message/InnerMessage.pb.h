...
enum InnerMessage_traits {
  InnerMessage_traits_value = 8400
};
...
class InnerMessage : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:game_connection.InnerMessage)
 private:
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_connection::InnerMessage_traits>() {
  return ::game_connection::InnerMessage_traits_descriptor();
}
