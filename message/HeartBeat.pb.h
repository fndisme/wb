...
class HeartBeat : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:game_connection.HeartBeat)
 private:
...
// optional int32 dummy = 1;
inline bool HeartBeat::has_dummy() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void HeartBeat::set_has_dummy() {
  _has_bits_[0] |= 0x00000001u;
}
inline void HeartBeat::clear_has_dummy() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void HeartBeat::clear_dummy() {
  dummy_ = 0;
  clear_has_dummy();
}
inline ::google::protobuf::int32 HeartBeat::dummy() const {
  return dummy_;
}
inline void HeartBeat::set_dummy(::google::protobuf::int32 value) {
  set_has_dummy();
  dummy_ = value;
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_connection::HeartBeat_traits>() {
  return ::game_connection::HeartBeat_traits_descriptor();
}
